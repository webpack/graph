...
Node.prototype.toJSON = function() {
	return {
		...
		size: this.size,
		main: this.main,
		linksAsync: this.linksAsync,
		linksWeight: this.linksWeight
	};
}
...
Node.prototype.prepare = function() {
	this.libaryIndex = Object.keys(this.linksWeight).length / this.links.length;
}
...
Node.prototype.getStrongness = function(node) {
	var direction = !!this.linksWeight[node.name];
...
Node.prototype.getSpeedNumber = function() {
	return this.speed[0] * this.speed[0] + this.speed[1] * this.speed[1];
}
